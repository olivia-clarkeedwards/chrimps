...
export default function Combat() {
  ...
  return (
    <div className="flex w-full flex-col justify-center h-full p-4 shadow-inner shadow-amber-800 rounded-3xl m-2 text-white basis-4/5 md:basis-2/5 bg-gradient-to-b from-purple-800 via-purple-900 to-violet-950">
      {zone > 4 && (
