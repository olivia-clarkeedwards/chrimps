...
```sh
pnpm create bati --react --tailwindcss --authjs --express --sqlite --eslint --prettier
```
...
<!--bati:start category="Database" flag="sqlite"-->
...
<!--bati:end category="Database" flag="sqlite"-->
